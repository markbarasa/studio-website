...
const SERVICES: Service[] = [
  ...
  // ⬇️ NEW MUSIC VIDEO SERVICE ⬇️
  {
    ...
    packages: [
      {
        id: "mv1",
        name: "Basic Music Video",
        price: 10000,
        features: [
          "1 Shooting Day",
          "1 Videographer",
          "Single Location",
          "Basic Editing (2-3 minutes)",
          "Color Grading",
          "MP4 Delivery",
        ],
      },
      {
        id: "mv2",
        name: "Music Video (with Drone)",
        price: 15000,
        features: [
          "1 Shooting Day",
          "1 Videographer + Drone Operator",
          "Single Location",
          "Aerial Footage",
          "Advanced Editing (3-4 minutes)",
      ...
      {
        id: "mv3",
        name: "Premium Music Video",
        price: 35000,
        features: [
          "2 Shooting Days",
          "2 Videographers + Drone Operator",
          "Multiple Locations",
          "Full Aerial Coverage",
          "Cinematic Editing (4-5 minutes)",
          "Professional Color Grading",
          "BTS Footage Included",
          "MP4 + Social Cuts + Lyrics Video",
        ],
      },
      {
        id: "choir1",
